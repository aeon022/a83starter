        ...
        <div class="row">
            ...
            <div class="content-area col-md-8 content-area" id="primary">
                <main class="site-main" id="main">
                    <h1><?php _e( 'Search Results for:', 'a83starter' ); ?> <span><?php echo esc_html( get_search_query( false ) ); ?></span></h1>
                        ...
                        <?php while ( have_posts() ) : the_post(); ?>
                            ...
                            <article <?php post_class( 'mb-5' ); ?> id="post-<?php the_ID(); ?>">
                                ...
                                <div class="entry-content">
                                    <?php the_excerpt( ); ?><a class="btn btn-secondary" href="<?php echo esc_url( get_permalink() ); ?>"><?php _e( 'Read More', 'a83starter' ); ?></a>
                                </div>
                                <footer class="entry-footer"></footer>
                            </article>
                        <?php endwhile; ?>
                    <?php else : ?>
                        <p class="lead text-muted"><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'a83starter' ); ?></p>
                    <?php endif; ?>
                    <?php if ( !have_posts() ) : ?>
