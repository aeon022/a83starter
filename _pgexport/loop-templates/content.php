        ...
        <?php while ( have_posts() ) : the_post(); ?>
            ...
            <article <?php post_class( 'mb-5' ); ?> id="post-<?php the_ID(); ?>">
                <header class="entry-header">
                    ...
                    <?php else : ?>
                        <h2 class="text-primary"><a href="<?php echo esc_url( get_permalink() ); ?>"><?php the_title(); ?></a></h2>
                    <?php endif; ?>
                ...
                <div class="entry-content">
                    <?php the_excerpt( ); ?>
                    <a class="btn btn-secondary" href="<?php echo esc_url( get_permalink() ); ?>"><?php _e( 'Read More', 'a83starter' ); ?></a>
                </div>
