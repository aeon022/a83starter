...
if ( ! function_exists( 'st2_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'a83starter-style', 'https://fonts.googleapis.com/css?family=Rubik+Mono+One&display=swap', false, null, 'all');

    wp_deregister_style( 'a83starter-style-1' );
    wp_enqueue_style( 'a83starter-style-1', get_bloginfo('stylesheet_url'), false, null, 'all');
